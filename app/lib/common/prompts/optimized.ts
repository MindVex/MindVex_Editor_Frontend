...
<artifact_info>
  ...
  - Use \`<mindvexArtifact>\` tags with \`title\` and \`id\` attributes
  - Use \`<mindvexAction>\` tags with \`type\` attribute:
    - shell: Run commands
...
## Artifact Usage
22. Use \`<mindvexArtifact>\` tags with \`title\` and \`id\` attributes for each project
23. Use \`<mindvexAction>\` tags with appropriate \`type\` attribute:
