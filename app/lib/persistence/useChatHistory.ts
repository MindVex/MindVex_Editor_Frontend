            ...
            if (startingIdx > 0) {
              ...
              filteredMessages = [
                ...
                },
                {
                  ...
                  content: `MindVex Restored your chat from a snapshot. You can revert this message to load the full chat history.
                  <mindvexArtifact id="restored-project-setup" title="Restored Project & Setup" type="bundled">
                  ${Object.entries(snapshot?.files || {})
                    .map(([key, value]) => {
                      if (value?.type === 'file') {
                        return `
                      <mindvexAction type="file" filePath="${key}">
${value.content}
                      </mindvexAction>
                      `;
                      } else {
