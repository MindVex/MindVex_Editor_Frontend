...
MindVex is initializing your project with the required files using the ${template.name} template.
<mindvexArtifact id="imported-files" title="${title || 'Create initial files'}" type="bundled">
${filesToImport.files
  .map(
    (file) =>
