                  ...
                  <CardContent className="space-y-4">
                    {isLoadingModels ? (
                      ...
                      <div className="text-center py-8">
                        ...
                        <h3 className="text-lg font-medium text-mindvex-elements-textPrimary mb-2">No Models Installed</h3>
                  ...
                  <CardContent className="space-y-4">
                    {isLoadingLMStudioModels ? (
                      ...
                      <div className="text-center py-8">
                        ...
                        <h3 className="text-lg font-medium text-mindvex-elements-textPrimary mb-2">No Models Available</h3>
                        <p className="text-sm text-mindvex-elements-textSecondary mb-4">
        ...
        {filteredProviders.length === 0 && (
          <Card className="bg-mindvex-elements-background-depth-2">
            <CardContent className="p-8 text-center">
              ...
              <h3 className="text-lg font-medium text-mindvex-elements-textPrimary mb-2">No Local Providers Available</h3>
