        ...
        <CardContent className="p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-mindvex-elements-textSecondary">Recommended hardware for optimal performance</p>
            </div>
          </div>
                ...
                <div className="space-y-2">
                  ...
                  <ol className="text-xs text-mindvex-elements-textSecondary space-y-1 list-decimal list-inside ml-2">
                    ...
                    <li>
                      ...
                      <code className="bg-mindvex-elements-background-depth-4 px-1 rounded">lms server start --cors</code>
                    </li>
                  </ol>
                </div>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div className="p-3 rounded-lg bg-mindvex-elements-background-depth-3">
                  ...
                  <p className="text-xs text-mindvex-elements-textSecondary">Focus on creative writing and storytelling</p>
                </div>
              </div>
            </div>
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="p-3 rounded-lg bg-mindvex-elements-background-depth-3">
                  ...
                  <p className="text-xs text-mindvex-elements-textSecondary">Access to 100+ models through unified API</p>
                </div>
                <div className="p-3 rounded-lg bg-mindvex-elements-background-depth-3">
                  <div className="flex items-center gap-2 mb-1">
                ...
                <div className="p-3 rounded-lg bg-mindvex-elements-background-depth-3">
                  ...
                  <p className="text-xs text-mindvex-elements-textSecondary">Ultra-fast LPU inference for Llama models</p>
                </div>
              </div>
            </div>
          </div>
