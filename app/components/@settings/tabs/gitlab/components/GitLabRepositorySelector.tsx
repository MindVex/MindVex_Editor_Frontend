  ...
  if (!isConnected || !connection) {
    return (
      <div className="text-center p-8">
        <p className="text-mindvex-elements-textSecondary mb-4">Please connect to GitLab first to browse repositories</p>
    ...
    return (
      <div className="text-center p-8">
        <div className="text-red-500 mb-4">
          ...
          <p className="text-sm text-mindvex-elements-textSecondary mt-1">{error}</p>
        </div>
