    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center gap-2">
          <GithubLogo />
          <h2 className="text-lg font-medium text-mindvex-elements-textPrimary">GitHub Integration</h2>
        </div>
    ...
    <GitHubErrorBoundary>
      <div className="space-y-6">
                ...
                <div className="flex items-center justify-between p-4 rounded-lg bg-mindvex-elements-background dark:bg-mindvex-elements-background-depth-2 border border-mindvex-elements-borderColor dark:border-mindvex-elements-borderColor hover:border-mindvex-elements-borderColorActive/70 dark:hover:border-mindvex-elements-borderColorActive/70 transition-all duration-200">
                  ...
                  <ChevronDown
                    className={classNames(
                      'w-4 h-4 transform transition-transform duration-200 text-mindvex-elements-textSecondary',
                  ...
                  {stats.repos.length > 12 && !isReposExpanded && (
                    <div className="text-center">
                      <Button
                        ...
                        className="text-mindvex-elements-textSecondary hover:text-mindvex-elements-textPrimary"
                      >
        ...
        {isConnected && connection && (
          <div className="mt-8 pt-6 border-t border-mindvex-elements-borderColor">
