...
export function BaseArchitectureDiagram() {
  return (
    <div className="flex flex-col h-full w-full p-6">
      ...
      <h1 className="text-2xl font-bold text-mindvex-elements-textPrimary mb-6">Architecture Diagram</h1>
      <div className="flex-1 bg-mindvex-elements-background-depth-2 rounded-lg border border-mindvex-elements-borderColor flex items-center justify-center">
        <p className="text-mindvex-elements-textSecondary">Architecture diagram visualization</p>
      </div>
    </div>
  );
}