      ...
      >
        <div
          className={classNames(
            ...
            'p-1 rounded-lg text-mindvex-elements-item-contentAccent',
            'flex ',
          )}
        >
          ...
          <motion.button
            ...
            className=" p-1 rounded-lg bg-mindvex-elements-item-backgroundAccent hover:bg-mindvex-elements-artifacts-backgroundHover"
