        ...
        <button
          ...
          className={classNames(
            ...
            tab.id === activeTab
              ...
              : classNames(
                  'bg-mindvex-elements-background-depth-2 dark:bg-mindvex-elements-background-depth-3 text-mindvex-elements-textPrimary dark:text-mindvex-elements-textPrimary-dark hover:bg-mindvex-elements-background-depth-3 dark:hover:bg-mindvex-elements-background-depth-4 border border-mindvex-elements-borderColor dark:border-mindvex-elements-borderColor-dark',
                  tabClassName,
                ),
          )}
        >
