      ...
      <div className="flex items-center gap-1.5">
        ...
        <span
          className={classNames(
            isLast
              ? 'font-medium text-mindvex-elements-textPrimary dark:text-mindvex-elements-textPrimary-dark'
              : 'text-mindvex-elements-textSecondary dark:text-mindvex-elements-textSecondary-dark hover:text-mindvex-elements-textPrimary dark:hover:text-mindvex-elements-textPrimary-dark',
            ...
            <li key={index} className="flex items-center">
              ...
              {!isLast && (
                <span
                  className={classNames(
                    separator,
                    'w-3 h-3 mx-1 text-mindvex-elements-textTertiary dark:text-mindvex-elements-textTertiary-dark',
                  )}
                />
              )}
            </li>
