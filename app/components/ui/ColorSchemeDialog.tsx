  ...
  const renderColorSection = () => (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <h3 className="text-lg font-semibold text-mindvex-elements-textPrimary flex items-center gap-2">
          <div className="w-2 h-2 rounded-full bg-mindvex-elements-item-contentAccent"></div>
          Color Palette
        </h3>
        <button
          onClick={handleReset}
          ...
          <div
            ...
            <div className="relative flex-shrink-0">
              ...
              <input
                ...
                tabIndex={-1}
              />
              <div className="absolute -bottom-1 -right-1 w-4 h-4 bg-mindvex-elements-bg-depth-1 rounded-full flex items-center justify-center shadow-sm">
                <span className="i-ph:pencil-simple text-xs text-mindvex-elements-textSecondary" />
              </div>
            </div>
            <div className="flex-1 min-w-0">
              <div className="font-semibold text-mindvex-elements-textPrimary transition-colors">{role.label}</div>
              <div className="text-sm text-mindvex-elements-textSecondary line-clamp-2 leading-relaxed">
                {role.description}
              </div>
              <div className="text-xs text-mindvex-elements-textTertiary font-mono mt-1 px-2 py-1 bg-mindvex-elements-bg-depth-1 rounded-md inline-block">
                {palette[role.key]}
              </div>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 max-h-80 overflow-y-auto pr-2 custom-scrollbar">
        {designFonts.map((f) => (
          <button
            ...
            className={`group p-4 rounded-xl border-2 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-mindvex-elements-borderColorActive ${
              font.includes(f.key)
                ? 'bg-mindvex-elements-item-backgroundAccent border-mindvex-elements-borderColorActive shadow-lg'
                : 'bg-mindvex-elements-background-depth-3 border-mindvex-elements-borderColor hover:border-mindvex-elements-borderColorActive hover:bg-mindvex-elements-bg-depth-2'
            }`}
          >
            <div className="text-center space-y-2">
              ...
              {font.includes(f.key) && (
                <div className="w-6 h-6 mx-auto bg-mindvex-elements-item-contentAccent rounded-full flex items-center justify-center">
          ...
          return (
            <div key={f.key} className="feature-card-container p-2">
              <button
                ...
                className={`group relative w-full p-6 text-sm font-medium transition-all duration-200 bg-mindvex-elements-background-depth-3 text-mindvex-elements-item-textSecondary ${
                  f.key === 'rounded'
                    ? isSelected
                      ? 'rounded-3xl'
                      : 'rounded-xl'
                  ...
                  f.key === 'border'
                    ? isSelected
                      ? 'border-3 border-mindvex-elements-borderColorActive bg-mindvex-elements-item-backgroundAccent text-mindvex-elements-item-contentAccent'
                      : 'border-2 border-mindvex-elements-borderColor hover:border-mindvex-elements-borderColorActive text-mindvex-elements-textSecondary'
                    : f.key === 'gradient'
                      ? ''
                      : isSelected
                        ? 'bg-mindvex-elements-item-backgroundAccent text-mindvex-elements-item-contentAccent shadow-lg'
                        : 'bg-mindvex-elements-bg-depth-3 hover:bg-mindvex-elements-bg-depth-2 text-mindvex-elements-textSecondary hover:text-mindvex-elements-textPrimary'
              ...
              >
                <div className="flex flex-col items-center gap-4">
                  <div className="flex items-center justify-center w-12 h-12 rounded-xl bg-mindvex-elements-bg-depth-1 bg-opacity-20">
                    {f.key === 'rounded' && (
                      <div
    ...
    <div>
      ...
      <DialogRoot open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <Dialog>
          <div className="py-4 px-4 min-w-[480px] max-w-[90vw] max-h-[85vh] flex flex-col gap-6 overflow-hidden">
            <div className="">
              <DialogTitle className="text-2xl font-bold text-mindvex-elements-textPrimary">
                Design Palette & Features
              </DialogTitle>
              <DialogDescription className="text-mindvex-elements-textSecondary leading-relaxed">
            ...
            {/* Navigation Tabs */}
            <div className="flex gap-1 p-1 bg-mindvex-elements-bg-depth-3 rounded-xl">
              {[
                ...
                <button
                  ...
                  className={`flex-1 flex items-center justify-center gap-2 px-4 py-3 rounded-lg font-medium transition-all duration-200 ${
                    activeSection === tab.key
                      ? 'bg-mindvex-elements-background-depth-3 text-mindvex-elements-textPrimary shadow-md'
                      : 'bg-mindvex-elements-background-depth-2 text-mindvex-elements-textSecondary hover:text-mindvex-elements-textPrimary hover:bg-mindvex-elements-bg-depth-2'
                  }`}
                >
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex gap-3">
                ...
                <Button
                  variant="ghost"
                  onClick={handleSave}
                  className="bg-mindvex-elements-button-primary-background hover:bg-mindvex-elements-button-primary-backgroundHover text-mindvex-elements-button-primary-text"
                >
                  Save Changes
                </Button>
              </div>
      ...
      <style>{`
        .custom-scrollbar {
          ...
          scrollbar-color: var(--mindvex-elements-textTertiary) transparent;
        }
        ...
        .custom-scrollbar::-webkit-scrollbar-thumb {
          background-color: var(--mindvex-elements-textTertiary);
          border-radius: 3px;
        }
        .custom-scrollbar::-webkit-scrollbar-thumb:hover {
          background-color: var(--mindvex-elements-textSecondary);
        }
        .line-clamp-2 {
          display: -webkit-box;
          -webkit-line-clamp: 2;
