  ...
  return (
    <div
      ...
      className={classNames(
        'rounded-lg border border-mindvex-elements-borderColor bg-mindvex-elements-background-depth-1 text-mindvex-elements-textPrimary shadow-sm',
        className,
      )}
      {...props}
    />
...
const CardDescription = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    return <p ref={ref} className={classNames('text-sm text-mindvex-elements-textSecondary', className)} {...props} />;
  },
);
