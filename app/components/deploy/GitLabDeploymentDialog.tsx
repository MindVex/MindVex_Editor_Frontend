              ...
              >
                ...
                <div className="relative text-center space-y-4">
                  ...
                  <motion.div
                    ...
                    className="mx-auto w-16 h-16 rounded-xl bg-mindvex-elements-background-depth-3 flex items-center justify-center text-orange-500"
                  >
              ...
              <div className="p-6">
                <div className="flex items-center gap-4 mb-6">
                  <motion.div
                    ...
                    animate={{ scale: 1 }}
                    transition={{ delay: 0.1 }}
                    className="w-10 h-10 rounded-xl bg-mindvex-elements-background-depth-3 flex items-center justify-center text-orange-500"
                  >
                ...
                <div className="flex items-center gap-3 mb-6 p-4 bg-mindvex-elements-background-depth-2 dark:bg-mindvex-elements-background-depth-3 rounded-lg border border-mindvex-elements-borderColor dark:border-mindvex-elements-borderColor-dark">
                  <div className="relative">
                    ...
                    <div
                      className="avatar-fallback w-10 h-10 rounded-full bg-mindvex-elements-background-depth-4 flex items-center justify-center text-mindvex-elements-textSecondary font-semibold text-sm"
                      style={{
                        display:
                            ...
                            >
                              <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                  ...
                                  <span className="text-sm font-medium text-mindvex-elements-textPrimary dark:text-mindvex-elements-textPrimary-dark group-hover:text-orange-500">
                                    {repo.name}
                                  </span>
                                </div>
                  ...
                  <div className="p-3 bg-mindvex-elements-background-depth-2 dark:bg-mindvex-elements-background-depth-3 rounded-lg border border-mindvex-elements-borderColor dark:border-mindvex-elements-borderColor-dark">
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        className="rounded border-mindvex-elements-borderColor dark:border-mindvex-elements-borderColor-dark text-orange-500 focus:ring-orange-500 dark:bg-mindvex-elements-background-depth-3"
                      />
                      <label
                        htmlFor="private"
