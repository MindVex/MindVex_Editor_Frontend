  ...
  return (
    ...
    >
      <div className="h-full">
        <div className="bg-mindvex-elements-terminals-background h-full flex flex-col">
          <div className="flex items-center bg-mindvex-elements-background-depth-2 border-y border-mindvex-elements-borderColor gap-1.5 min-h-[34px] p-2">
                  ...
                  {index == 0 ? (
                    <button
                      ...
                      className={classNames(
                        ...
                        {
                          'bg-mindvex-elements-terminals-buttonBackground text-mindvex-elements-textSecondary hover:text-mindvex-elements-textPrimary':
                            isActive,
                    ...
                    <React.Fragment>
                      ...
                      >
                        ...
                        <button
                          className="bg-transparent text-mindvex-elements-textTertiary hover:text-mindvex-elements-textPrimary hover:bg-transparent rounded"
                          onClick={(e) => {
                            e.stopPropagation();
                            closeTerminal(index);
                          }}
            ...
            <IconButton
              ...
              onClick={() => {
                ...
                if (ref?.getTerminal()) {
                  ...
                  if (activeTerminal === 0) {
                    workbenchStore.attachMindvexTerminal(terminal);
                  } else {
              ...
              return (
                <React.Fragment key={`terminal-container-${index}`}>
                  <Terminal
                    ...
                    onTerminalReady={(terminal) => workbenchStore.attachMindvexTerminal(terminal)}
